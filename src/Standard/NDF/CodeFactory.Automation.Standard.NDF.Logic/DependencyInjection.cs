...
namespace CodeFactory.Automation.Standard.NDF.Logic
{
    ...
    public static class DependencyInjection
    {
        ...
        private static readonly ILogger _logger = LogManager.GetLogger(typeof(DependencyInjection));
        ...
        public static async Task<bool> HasMicrosoftExtensionDependencyInjectionLibrariesAsync(this VsProject sourceProject)
        {
            ...
            bool returnResult = references.Any(r => r.Name == AspNetConstants.DependencyInjectionAbstractions);
            if (!returnResult) return false;

            //Checking for the configuration libraries.
            returnResult = references.Any(r => r.Name == AspNetConstants.ConfigurationAbstractions);
            return returnResult;
        }
        ...
        private static string FormatTransientRegistration(CsClass classData, string serviceCollectionParameterName, NamespaceManager manager = null)
        {
            ...
            classType = classData.GenerateClassTypeNameNDF(manager);
            ...
            if (classData.InheritedInterfaces.Any())
            {
                ...
                if (interfaceData != null) registrationType = interfaceData.GenerateInterfaceTypeNameNDF(manager);
            }
