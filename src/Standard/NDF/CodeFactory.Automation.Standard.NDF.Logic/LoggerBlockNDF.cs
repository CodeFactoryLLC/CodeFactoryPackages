...
namespace CodeFactory.Automation.Standard.NDF.Logic
{
    ...
    /// </summary>
    public class LoggerBlockNDF:BaseLoggerBlock
    {
        /// <summary>Constructor for the base class implementation.</summary>
        /// <param name="fieldName">The name of the logger field.</param>
        public LoggerBlockNDF(string fieldName) : base(fieldName,"TraceLog","DebugLog","InformationLog","WarningLog","ErrorLog","CriticalLog")
        {
            //Intentionally blank
        }
