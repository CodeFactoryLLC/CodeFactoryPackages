...
namespace CodeFactory.Automation.Standard.Logic
{
 /// <summary>
    ...
    public class PropertyBuilderTransformNullableTypes : BasePropertyBuilder
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="PropertyBuilderTransformNullableTypes"/>
        /// </summary>
        ...
        public PropertyBuilderTransformNullableTypes(bool transformNullableTypes)
        {
            ...
            IEnumerable<NamedSyntax> multipleSyntax = null, NameFormatting nameFormat = null)
        {
            ...
            //Bug fix 10-2-2023 Added ability to make sure and not add attribute namespaces unless requested.
            await manager.AddMissingUsingStatementsAsync(sourceModel,includeAttributes);
