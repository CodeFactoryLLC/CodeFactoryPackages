...
namespace CodeFactory.Automation.NDF.Logic
{
    ...
    /// </summary>
    public class BoundsCheckBlockStringNDFException:BaseBoundsCheckBlock
    {
        ...
        public BoundsCheckBlockStringNDFException(bool ignoreWhenDefaultValueIsSet, ILoggerBlock loggerBlock) : base(nameof(BoundsCheckBlockStringNDFException), ignoreWhenDefaultValueIsSet, loggerBlock)
        {
        }
