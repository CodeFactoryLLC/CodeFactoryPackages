...
namespace CodeFactory.Automation.NDF.Logic.AspNetCore.Blazor
{
    ...
    /// </summary>
    public class BoundsCheckBlockNullBlazorControllerMessage:BaseBoundsCheckBlock
    {
        ...
        public BoundsCheckBlockNullBlazorControllerMessage(bool ignoreWhenDefaultValueIsSet, ILoggerBlock loggerBlock, string showErrorMethodName = null) : base(nameof(BoundsCheckBlockNullNDFException), ignoreWhenDefaultValueIsSet, loggerBlock)
        {
        ...
        public override (bool hasBoundsCheck, string boundsCheckSyntax) GenerateBoundsCheck(CsMethod sourceMethod, CsParameter checkParameter)
        {
            ...
            formatter.AppendCodeLine(1,$"var argumentNull =  new ArgumentNullException(nameof({checkParameter.Name}));");
            formatter.AppendCodeLine(1,$"{_showErrorMessageName}(argumentNull.Message);");
            formatter.AppendCodeLine(0,"}");
