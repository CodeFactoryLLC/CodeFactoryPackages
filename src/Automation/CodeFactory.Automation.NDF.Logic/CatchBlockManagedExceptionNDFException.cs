...
/// <summary>
    ...
    /// </summary>
    public class CatchBlockManagedExceptionNDFException:BaseCatchBlock
    {
        /// <summary>
        ...
        public CatchBlockManagedExceptionNDFException(ILoggerBlock loggerBlock = null,LogLevel logLevel = LogLevel.Information) : base(loggerBlock)
        {
            _logLevel = logLevel;
        }
