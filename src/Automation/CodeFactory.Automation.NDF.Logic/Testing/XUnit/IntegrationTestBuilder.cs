...
namespace CodeFactory.Automation.NDF.Logic.Testing.XUnit
{
    ...
    public static class IntegrationTestBuilder
    {
        ...
        public static async Task RefreshXUnitIntegrationTestAsync(this IVsActions source, string testName, CsInterface contract, VsProject testProject,List<string> testPrefixes = null)
        {
            ...
            if (testSource == null) await source.CreateTestAsync(contract, testProject, testClassName,testPrefixes);
            else await source.UpdateTestAsync(contract, testSource.SourceCode,testPrefixes);
        ...
        public static async Task CreateTestAsync(this IVsActions source, CsInterface contract, VsProject testProject, string testClassName, List<string> testPrefixes = null)
        {
        ...
        /// <summary>
        /// Updates a test class that performs integration tests on the target contract.
        /// </summary>
        /// <param name="source">CodeFactory automation for visual studio.</param>
        ...
        public static async Task UpdateTestAsync(this IVsActions source, CsInterface contract, CsSource testClassSource, List<string> testPrefixes = null)
        {
            ...
            if (testClass == null) throw new CodeFactoryException($"The test class could not be loaded from the provided source. cannot update the integration tests that support the contract '{contract.Name}'");
