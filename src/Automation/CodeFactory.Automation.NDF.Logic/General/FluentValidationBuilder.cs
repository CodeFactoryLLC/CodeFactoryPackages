...
namespace CodeFactory.Automation.NDF.Logic.General
{
    ...
    public static class FluentValidationBuilder
    {
        ...
        public static async Task<CsClass> RefreshValidationClassAsync(this IVsActions source, CsClass sourceClass,
            VsProject sourceProject, VsProjectFolder sourceFolder = null, NameManagement nameManagement = null)
        {
            ...
            var validationClass = validationSourceCode?.Classes?.FirstOrDefault(c => c.Name == validationClassName);

            await source.RegisterTransientClassesAsync(sourceProject);
