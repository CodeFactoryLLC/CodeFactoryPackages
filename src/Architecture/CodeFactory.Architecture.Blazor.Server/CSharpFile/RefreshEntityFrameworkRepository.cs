...
#pragma warning disable CS1998
        ...
        /// <summary>
        /// The target folder where application entity validators will be created and stored. This is optional and only used when entity validators are stored in a target folder.
        /// </summary>
        public static string EntityValidatorFolder = "EntityValidatorFolder";
        ...
        /// <summary>
        /// Optional, list of prefixes separated by comma to remove from the name of the entity framework entity.
        /// </summary>
        ...
        /// <summary>
        /// Optional, prefix to assign to an application model when creating.
        /// </summary>
        public static string AppModelPrefix ="AppModelPrefix"; 

        /// <summary>
        /// Optional, suffix to assign to an application model when creating.
        /// </summary>
        public static string AppModelSuffix ="AppModelSuffix"; 

        /// <summary>
        /// Optional, prefix to assign to an integration test when creating.
        /// </summary>
        public static string TestPrefix ="TestPrefix"; 

        /// <summary>
        /// Optional, suffix to assign to an integration test when creating.
        /// </summary>
        public static string TestSuffix ="TestSuffix"; 

        /// <summary>
        /// The prefix to assign to the name of an application models validation class.
        /// </summary>
        public static string AppModelValidatorPrefix = "AppModelValidatorPrefix";

        /// <summary>
        /// The suffix to assign to the name of an application models validation class.
        /// </summary>
                ...
                (
                    ...
                    (
                        ...
                        { 
                            ...
                            Guidance = "Comma separated value list of the prefixes in case sensitive format to be removed from the entity framework entity name when creating new objects."
                        }
                    )
                    .AddParameter
                    (
        ...
        public override async Task ExecuteCommandAsync(VsCSharpSource result)
        {
            try
            {
                ...
                VsProjectFolder appModelValidatorFolder =
                    await VisualStudioActions.GetProjectFolderFromConfigAsync(command.Project(EntityProject), EntityValidatorFolder) ?? appModelFolder;
                ...
                await VisualStudioActions.RefreshDbContextAsync(contextClassName, efModelProject, null);
